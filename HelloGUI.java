...
private JTextField inputField4;
    ...
    /* private void createAndShowGUI() {
        ...
        panel.add(new JLabel("Ange dim. effekt (kw):"));
        panel.add(inputField1);
        panel.add(new JLabel("Ange temp inomhus (degC):"));
        panel.add(inputField2);
        panel.add(new JLabel("Enter Number 3:"));
        panel.add(inputField3);
        panel.add(new JLabel("Ange årsmedel temperatur:"));
