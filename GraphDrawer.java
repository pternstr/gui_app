...
public class GraphDrawer extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Draw tick marks and labels for the x-axis on the BufferedImage's Graphics2D context
        ...
        // Draw tick marks and labels for the y-axis on the BufferedImage's Graphics2D context
    ...
    private int mapYToPixel(float y, double minGrader, double maxGrader) {
        return HEIGHT - MARGIN - (int) ((y - minGrader) * (HEIGHT - 2 * MARGIN) / (maxGrader - minGrader));
    } */
...
protected void paintComponent(Graphics g) {
    ...
    for (int i = 0; i <= 10; i++) {
        ...
        g2d.drawString(Integer.toString(i * 876), x - 10, HEIGHT - MARGIN + 20); // label
    }
